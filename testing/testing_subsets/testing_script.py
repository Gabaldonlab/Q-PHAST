...
for d in ["AST_48h_subset", "Classic_spottest_subset", "Fitness_only_subset", "Stress_plates_subset"]:
    ...
    if fun.file_is_empty(finish_file):
        ...
        cmd = "python %s --os %s --input %s --docker_image mikischikora/q-phast:v1 --output %s --min_nAUC_to_beConsideredGrowing 0.5"%(main_script, running_os, input_dir, output_dir)
